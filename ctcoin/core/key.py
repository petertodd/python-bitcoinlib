...
class CECKey:
    ...
    def sign(self, hash): # pylint: disable=redefined-builtin
        ...
        assert 1 == result
        if ctcoin.core.script.IsLowDERSignature(mb_sig.raw[:sig_size0.value]):
    ...
    def sign_compact(self, hash): # pylint: disable=redefined-builtin
        ...
        sig = ctcoin.signature.DERSignature.deserialize(sig)
